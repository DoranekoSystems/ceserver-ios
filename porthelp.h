...
} handleType;  // The difference between ThreadHandle and NativeThreadHandle is
               // that threadhandle is based on the processid of the thread, the
               // NativeThreadHandle is in linux usually the pthread_t handle
